...
author: |
  | Olivier Sigtermans
  | o.v.sigtermans@students.uu.nl
  | http://www.github.com/Oliviersigt
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
**Designated place**:
As can be seen in the table, the mean and median of countries that have not had any revolutions in this time period is higher than the mean and median of the countries that have had revolutions. This means that not having any revolutions is on average better for the growth of a country. The median growth of the country that has had no revolutions is higher than the country that has had revolutions, likely because revolutions are often times set backs in an economy as resources are used to fight governments or unfair rules, meaning most of the economy stops as people focus on other things which takes a while for it to recover.
...
The $p$-value of the t-test is 0.06871.This $p$-value represents the probability of observing a test statistic as extreme as the one calculated (t = 1.8531) under the null hypothesis. In this case, since the $p$-value (0.06871) is greater than the commonly used significance level of 0.05, we would fail to reject the null hypothesis. This means that there is not sufficient evidence to conclude that there is a statistically significant difference between the means of the two groups.
...
Rgdp60 is the value of GDP per capita in 19160, converted to 1960 US dollars. I think that the variable is not really necessary as we are tracking the growth, and knowing the starting point without knowing the edning point is unnecessary. 
...
Tradeshare, as it reacts most heavily during the time period selected. 
...
modelsummary(list(model1, model2, model3, model4,), gof_map=c("nobs", "r.sqaured"),
